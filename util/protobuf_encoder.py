...
class ProtobufEncoder(object):
    ...
    def get_bytecode_data_request(self, epoch: int):
        assert self.dr_output, "Transaction not set"
        return bytes_to_hex(self.dr_output.hash(epoch, self.wip)), bytes_to_hex(self.dr_output.to_pb_bytes(epoch, self.wip))

    def validate_data_request(self, expected_data_request_bytes: str_or_none, expected_data_request_hash: str_or_none, expected_rad_request_hash: str_or_none, epoch: int) -> bool:
        try:
            data_request_hash, data_request_bytes = self.get_bytecode_data_request(epoch)
            rad_request_hash, rad_request_bytes = self.get_bytecode_RAD_request(epoch)
            assert expected_data_request_bytes == data_request_bytes
            assert expected_data_request_hash == data_request_hash
            assert expected_rad_request_hash == rad_request_hash
    ...
    def test_http_get_bytecode(self):
        ...
        assert self.validate_data_request(
            expected_data_request_bytes="",
            expected_data_request_hash="0de5c46c40dd9a97e529374a96ac30dc5d5a85bb3f721ed0c152e18b043d2cf1",
            expected_rad_request_hash="38894f317460d993b00d1c821078daae405ac203583295b9402d04f73d101104",
        ...
        assert self.validate_data_request(
            expected_data_request_bytes="",
            expected_data_request_hash="53be15928e684d456f8b7973a684834385a14d539c92b5e468029e68c54ab32a",
            expected_rad_request_hash="4dedccc82c58ae9daa0e1d79f35e494e38ffaa7a56b0728932850c9209bbb901",
    ...
    def test_rng_bytecode(self):
        ...
        assert self.validate_data_request(
            expected_data_request_bytes='0a0f120508011a01801a0210022202100b10a0c21e18022090a10f2833308094ebdc03',
            expected_data_request_hash='8ffefe7c5104479e73fdc8efba0bf137f73a3807c3b83515a9305df9d52537df',
            expected_rad_request_hash='d2abe8431d6220b0d313a65fad8aa92403e4eb436d86fb5964a7ae9c18e0c37c',
            epoch=pre_wip0019_epoch,
        ) is False
        ...
        # After WIP 0020 activation the valid types are {0: "Unknown", 1: "HTTP-GET", 2: "RNG", 3: "HTTP-POST" }
        assert self.validate_data_request(
            expected_data_request_bytes='0a0f120508021a01801a0210022202100b10a0c21e18022090a10f2833308094ebdc03',
            expected_data_request_hash='0dd4be45fe46949658d276b2a9f8550f72c3352692cdcd718d16b87924fbc113',
            expected_rad_request_hash='65d6d4ee499b0bd13f0a96355ae30ede913555094a265b75305e904de1afbf3c',
            epoch=post_wip0020_epoch,
        )
    ...
    def test_http_post_bytecode(self):
        ...
        expected_data_request_bytes = ''
        expected_data_request_hash = 'caf2d1b4a778aecc324b3fd19cf2dc765bc58c640df4491557771bc813bea44d'
        expected_rad_request_hash = '6c97cf998a1c8bfcf0e3d519fe2f082f45524b0f768478488b6fa16b32353192'

        # Test pre WIP 0019
        # Before WIP 0019 activation, only RADType enum 0 position is valid {0: "HTTP-GET"} so this should return False
        assert self.validate_data_request(
            expected_data_request_bytes=expected_data_request_bytes,
            expected_data_request_hash=expected_data_request_hash,
            expected_rad_request_hash=expected_rad_request_hash,
            epoch=pre_wip0019_epoch,
        ) is False
